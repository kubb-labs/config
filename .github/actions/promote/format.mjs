// The heading grammar shared by each consuming repo's changelog writer and
// createReleases.mjs, which reads CHANGELOG.md back out. Kept in one place so
// the two can't drift into two independently-escaped, independently anchored
// regexes for the same headings.
